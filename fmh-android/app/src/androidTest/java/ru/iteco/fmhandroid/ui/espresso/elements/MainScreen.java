...
public class MainScreen {
    ...
    public ViewInteraction firstClaimExecutorName = onView(allOf(withId(R.id.claim_list_recycler_view), childAtPosition(withId(R.id.all_claims_cards_block_constraint_layout), 4)));
