...
public class AppActivityTest {
    ...
    public void appActivityTest() {
        ...
        ViewInteraction checkableImageButton = onView(
                allOf(withId(androidx.appcompat.R.id.text_input_end_icon), withContentDescription("Show dropdown menu"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.widget.LinearLayout")),
                                        1),
        ...
        ViewInteraction editText = onView(
                allOf(withId(R.id.description_edit_text), withText("Description"),
                        withParent(withParent(withId(R.id.description_text_input_layout))),
                        isDisplayed()));
        editText.check(matches(withText("Description")));
        ...
        ViewInteraction editText3 = onView(
                allOf(withId(R.id.executor_drop_menu_auto_complete_text_view), withText("Executor"),
                        withParent(withParent(withId(R.id.executor_drop_menu_text_input_layout))),
                        isDisplayed()));
        editText3.check(matches(withText("Executor")));
    }
